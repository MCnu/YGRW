...
for trajecs in range(0,100):
    ...
    gtt = generate_trajectory(timesteps = nsteps, 
                              stepper = FLESteps(step_batchsize=nsteps, 
                                                 gamma = adjgam, 
                                                 alpha = adjalpha, 
                                                 bound_gamma = adjbgam, 
    ...
    Trajectory.write_trajectory(gtt,output_file= f"URA3_20_80_FLE_{trajecs}.csv",
